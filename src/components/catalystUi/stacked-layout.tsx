  ...
  return (
    <div className="relative isolate flex min-h-svh w-full flex-col bg-white lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950">
      ...
      >
        ...
        <div className="min-w-0 flex-1  z-50">{navbar}</div>
      </header>

      {/* Content */}
      <main
        className="flex flex-1 flex-col pb-2 lg:px-2 scrollGutter-container z-10"
        // data-aos="fade-down"
        // data-aos-duration="700"
      >
        <div className="scrollGutter-container grow p-6 lg:rounded-lg lg:bg-white lg:p-14 lg:shadow-sm lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10">
